...
import numpy
import pandas as pd
from config import TRAIN_DATA, TRIP_DATA_1, RESULTS1ETEST
from code.utils import calcAndLogStats, transformPickupDatetime
from sklearn.neighbors import KNeighborsClassifier

def main(k=1, output=RESULTS1ETEST, weights='uniform'):
    """
    int -> None
    ...
    for k in range(5, 7):
        ...
        with open(output, "a+") as outputFile:
            ...
            calcAndLogStats( numpy.array(np.median(preds), 
